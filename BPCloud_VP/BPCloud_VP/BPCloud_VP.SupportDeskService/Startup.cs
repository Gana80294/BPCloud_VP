...
namespace BPCloud_VP.SupportDeskService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<SupportDeskContext>(o => o.UseSqlServer(Configuration.GetConnectionString("SupportDeskContext")));
            services.AddDbContext<SupportDeskContext>(options =>
            {
                options.UseSqlServer(Configuration.GetConnectionString("SupportDeskContext"),
            ...
            services.AddTransient<ISupportDeskRepository, SupportDeskRepository>();
        }

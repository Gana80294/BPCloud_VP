        ...
        public async Task<IActionResult> ValidateInvoiceAttachment()
        {
            ...
            try
            {
                ...
                if (postedfiles.Count > 0)
                {
                    ...
                    ocrtext = _ASNRepository.GetOCR(filePath, Plant, PatnerID);
                            ...
                            foreach (var line in lines)
                            {
                                if (!string.IsNullOrEmpty(line.Trim()))
                                {
                                    ...
                                    else if (((line.Contains("Total Current Charges")) || line.StartsWith("Total") || line.StartsWith("TOTAL")) && !line.StartsWith("Total In Words"))
                                    {
                                        ...
                                        {
                                            int taxindex = Array.IndexOf(amountsplit, "Charges");
                                            if (taxindex != -1)
                                            {
                                    ...
                                    {
                                        ar = line.Split(' ');
                                        int taxindex = Array.IndexOf(ar,"Tax");
                                        if (taxindex != -1)
                                        {
                                    ...
                                    if (line.StartsWith("Serial No of Invoice: "))
                                    {
                                        ...
                                        int Invoiceindex = Array.IndexOf(invoicenumber, "Invoice:");
                                        if (Invoiceindex != -1)
                                        {
                                    ...
                                    {
                                        invoicenumber = line.Split(' ');
                                        int Invoiceindex = Array.IndexOf(invoicenumber, "No.");
                                        if (Invoiceindex != -1)
                                        {
                                            for (int i = Invoiceindex + 1; i < invoicenumber.Length; i++)
                                            {
                                    ...
                                    {
                                        string[] splitinvoicenumber = line.Split(' ');
                                        int Invoiceindex = Array.IndexOf(splitinvoicenumber, "Number");
                                        if (Invoiceindex != -1)
                                        {

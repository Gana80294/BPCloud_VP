...
namespace BPCloud_VP.FactService.Repositories
{
    public class FactRepository : IFactRepository
    {
        ...
        public FactRepository(FactContext dbContext, IConfiguration configuration, IContactPersonRepository contactPersonRepository, ICertificateRepository certificateRepository, IBankRepository bankRepository)
        {
        ...
        public List<FTPAttachment> CreateAllAttachments(BPCFactSupport Fact, bool ISDecleration = true)
        {
            ...
            try
            {
                ...
                int num = r.Next(1, 9999999);
                string writerFolder = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "VendorTempFolder");
                Attachments = GetAllAttachmentsToFTP(Fact, ISDecleration);
